...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex h-screen bg-zinc-50 overflow-hidden font-geist">
      ...
      <aside className="hidden md:flex md:flex-col md:w-56 lg:w-60 shrink-0 border-r border-zinc-200 bg-white">
        ...
        <div className="px-4 py-3 border-b border-zinc-100">
          <p className="text-xs text-zinc-400 mb-1 font-medium uppercase tracking-wide">Active wedding</p>
          ...
          <div className="flex items-center gap-1.5 mt-1">
            ...
            <Badge variant="secondary" className="ml-auto text-[10px] px-1.5 py-0 h-4">{WEDDING.tier}</Badge>
          </div>
        </div>
